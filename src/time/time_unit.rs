//---------------------------------------------------------------------------------------------------- Use
use crate::macros::{impl_impl_math, impl_math, return_bad_float};
#[cfg(feature = "num")]
use crate::num::Unsigned;
use crate::time::{Military, Time};
#[cfg(feature = "up")]
...
impl TimeUnit {
    ...
    pub const fn from_hours(hours: u32) -> Self {
        Self::new(hours.saturating_mul(3_600))
    }
    ...
    pub const fn from_days(days: u16) -> Self {
        Self::new((days as u32).saturating_mul(86_400))
    }
    ...
    pub const fn from_weeks(weeks: u16) -> Self {
        Self::new((weeks as u32).saturating_mul(604_800))
    }
    ...
    pub const fn from_months(months: u16) -> Self {
        Self::new((months as u32).saturating_mul(2_678_400))
    }
    ...
    pub const fn from_years(years: u8) -> Self {
        Self::new((years as u32).saturating_mul(31_536_000))
    }
